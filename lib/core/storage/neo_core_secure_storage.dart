...
class _Constants {
  ...
  static const String secureStorageKeyLanguage = "secure_storage_key_language";
  static const String secureStorageKeyDeviceId = "secure_storage_key_device_id";
  static const String secureStorageKeyDeviceInfo = "secure_storage_key_device_info";
  static const String secureStorageKeyTokenId = "secure_storage_key_token_id";
  static const String secureStorageKeyAuthToken = "secure_storage_key_auth_token";
  static const String secureStorageKeyRefreshToken = "secure_storage_key_refresh_token";
  static const String secureStorageKeyCustomerId = "secure_storage_key_customer_id";
  static const String secureStorageKeyDeviceRegistrationToken = "secure_storage_key_device_registration_token";
  static const String secureStorageKeyCustomerNameAndSurname = "secure_storage_key_customer_name_and_surname";

  static const String sharedPreferencesFirstRun = "shared_preferences_first_run";

  static const keysToEliminate = [
    secureStorageKeyLanguage,
    secureStorageKeyDeviceInfo,
    secureStorageKeyTokenId,
    secureStorageKeyAuthToken,
    secureStorageKeyRefreshToken,
    secureStorageKeyCustomerId,
    secureStorageKeyDeviceRegistrationToken,
    secureStorageKeyCustomerNameAndSurname,
  ];
}
...
class NeoCoreSecureStorage {
  ...
  Future _checkFirstRun() async {
    if (_preferences!.getBool('first_run') ?? true) {
      await Future.wait(_Constants.keysToEliminate.map((key) => _storage!.delete(key: key)));
    }
