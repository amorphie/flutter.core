...
/// Utility class for DataManager key generation
class DataManagerUtils {
  ...
  static String buildWorkflowInstanceKey({
  ...
  static String buildWorkflowInstanceKeyFromContext(VNextContext context) {
  ...
  static String buildWorkflowInstanceKeyFromSnapshot(VNextInstanceSnapshot snapshot) {
    return buildWorkflowInstanceKey(
  ...
  static String buildWorkflowTransitionKey({
    required String domain,
    required String workflowName,
    required String instanceId,
  ...
  static String buildWorkflowTransitionKeyFromContext(VNextContext context) {
