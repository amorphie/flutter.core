enum NeoRegExps {
  ...
  alphanumericAndSpace("[a-zA-Z0-9\\s]+"),
  alphanumericAndSpecialCharacters("[a-zA-Z0-9çÇğĞıİöÖşŞüÜ\\s\\-.'@#\$%&*()_+=\\[\\]{}|\\\\/:;\"'`<>?,!~€£¥₺\"'']+"),
  alphanumericAndSpecialCharactersForTransfers("[a-zA-Z0-9çÇğĞıİöÖşŞüÜ\\s\\-.@#\$%*()_+=\\[\\]{}|\\\\/:;,!?~€£¥₺]+"),
  dateTimeWithMilliseconds("^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}\\.\\d{3}\$"),
  digitOnly("[0-9]*"),
  email("^\$|^([a-zA-Z0-9._-]+)@((?!-)(?=[a-zA-Z0-9-]*[a-zA-Z])[a-zA-Z0-9-]+(?<!-)(\\.[a-zA-Z]+)+)\$"),
  exactlySixDigits("^\\d{6}\$"),
  extendedSpecialCharacters("[a-zA-Z0-9çÇğĞıİöÖşŞüÜ\\s():\\-@.,_;#%*+=/?!]+"),
  findPlaceholdersInCurlyBraces(r"\{([^}]+)\}"),
  formattedNoCountryCodePhoneNumber("^5\\d{2} \\d{3} \\d{2} \\d{2}\$"),
  formattedPhoneNumberWithMask("^\\(\\d{3}\\) \\d{3} \\d{2} \\d{2}\$"),
  generalIban(r"^(?:[A-Z]{2}[0-9]{2}[A-Z0-9]{12,28}|[0-9]{2}[A-Z0-9]{12,28})$"),
  ibanWithOcrCharacters(r'[A-Z]{2}[0-9A-Z|¦!lL/\\j\[\]{}º°ⅼos]{13,32}'),
  invalidCharactersExceptOcr(r'[^0-9A-Z|¦!lL/\\j\[\]{}º°ⅼos]'),
  limitedSpecialCharacters("[a-zA-Z0-9çÇğĞıİöÖşŞüÜ\\s():\\-@.,_]+"),
  minFourCharacter("^.{4,}\$"),
  minEightCharacter(r"^.{8,}$"),
  minFiveCharacter(r"^.{5,}$"),
  minNineCharacter(r"^.{9,}$"),
  minSixCharacter("^.{6,}\$"),
  ...
  nonDollarPrefix("^(?!\$)"),
  nonEnglishCharacters("^[^QWXqwx]+"),
  nonZeroDigits("[1-9]\\d*"),
  notEmpty("^(?!\\s*\$).+"),
  numeric(r"^\d*$"),
  ocrCharactersAndAlphanumeric(r'[0-9A-Z|¦!lL/\\j\[\]{}º°ⅼos]'),
  ocrCharactersStarting(r'^[0-9|¦!lL/\\j\[\]{}º°ⅼos]'),
  onlyNumeric("[0-9]+"),
  ...
  static const Map<String, NeoRegExps> _jsonValues = {
    ...
    'NeoRegExps.alphanumericAndSpecialCharactersForTransfers': NeoRegExps.alphanumericAndSpecialCharactersForTransfers,
    'NeoRegExps.dateTimeWithMilliseconds': NeoRegExps.dateTimeWithMilliseconds,
    ...
    'NeoRegExps.extendedSpecialCharacters': NeoRegExps.extendedSpecialCharacters,
    ...
    'NeoRegExps.formattedPhoneNumberWithMask': NeoRegExps.formattedPhoneNumberWithMask,
    'NeoRegExps.generalIban': NeoRegExps.generalIban,
    'NeoRegExps.ibanWithOcrCharacters': NeoRegExps.ibanWithOcrCharacters,
    'NeoRegExps.invalidCharactersExceptOcr': NeoRegExps.invalidCharactersExceptOcr,
    ...
    'NeoRegExps.noLeadingSpace': NeoRegExps.noLeadingSpace,
    'NeoRegExps.noLeadingZero': NeoRegExps.noLeadingZero,
    'NeoRegExps.noOneOrTwoCharacter': NeoRegExps.noOneOrTwoCharacter,
    'NeoRegExps.noSpace': NeoRegExps.noSpace,
    'NeoRegExps.nonAlphanumeric': NeoRegExps.nonAlphanumeric,
    'NeoRegExps.nonDollarPrefix': NeoRegExps.nonDollarPrefix,
    'NeoRegExps.nonEnglishCharacters': NeoRegExps.nonEnglishCharacters,
    'NeoRegExps.nonZeroDigits': NeoRegExps.nonZeroDigits,
    'NeoRegExps.notEmpty': NeoRegExps.notEmpty,
    'NeoRegExps.numeric': NeoRegExps.numeric,
    'NeoRegExps.ocrCharactersAndAlphanumeric': NeoRegExps.ocrCharactersAndAlphanumeric,
    'NeoRegExps.ocrCharactersStarting': NeoRegExps.ocrCharactersStarting,
    ...
    'NeoRegExps.whitespace': NeoRegExps.whitespace,
  };
